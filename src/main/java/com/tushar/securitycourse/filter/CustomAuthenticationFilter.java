...
public class CustomAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response, AuthenticationException failed) throws IOException, ServletException {
        Map<String, String> unsuccessfulAuthentication = new HashMap<>();
        unsuccessfulAuthentication.put("errorCode", HttpStatus.UNAUTHORIZED.toString());
        unsuccessfulAuthentication.put("errorMessage", "Invalid credentials");
        response.setContentType("application/json");
        response.setStatus(HttpStatus.UNAUTHORIZED.value());
        new ObjectMapper().writeValue(response.getOutputStream(), unsuccessfulAuthentication);
    }
}
